...
public class ContactFragment extends Fragment {
    ...
    private ImageView satyaFb,tejasFb,parshyaFb,amolFb,satyaCall,tejasCall,parshyaCall,amolCall;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        satyaFb=(ImageView) view.findViewById(R.id.satya_fb);
        satyaCall=(ImageView) view.findViewById(R.id.satya_call);
        tejasFb=(ImageView) view.findViewById(R.id.tejas_fb);
        tejasCall=(ImageView) view.findViewById(R.id.tejas_call);
        parshyaFb=(ImageView) view.findViewById(R.id.parshya_fb);
